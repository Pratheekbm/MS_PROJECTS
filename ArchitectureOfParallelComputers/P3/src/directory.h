...
//	
    ulong get_invalidations() {
        return invalidations;
    }
//	
    virtual void signalRd(ulong, int) {
        return;
    }
    ;
    virtual void signalRdX(ulong, int) {
        return;
    }
    ;
    virtual void signalUpgr(ulong, int) {
        return;
    }
    ;
    virtual void Int(ulong) {
        return;
    }
    ;
    virtual void Inv(ulong) {
        return;
    }
    ;
};
